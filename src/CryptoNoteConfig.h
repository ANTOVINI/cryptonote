...
UINT64_C(999999999999999999999)
...
const uint64_t CRYPTONOTE_NUMBER_OF_PERIODS_TO_FORGET_TX_DELETED_FROM_POOL = 7;  CRYPTONOTE_MEMPOOL_TX_LIVETIME = time to forget tx
...
const char     CRYPTONOTE_NAME[]                             = "byterium";
...
const int      RPC_DEFAULT_PORT                              = 32774;
